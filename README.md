...
open = "https://img.shields.io/badge/${group_name}-open-green"
 -->
Join the public TestFlight (click on one of the badges): [![AstroDX Group A TestFlight status](https://img.shields.io/badge/Group%20A-closed-yellow)](https://testflight.apple.com/join/rACTLjPL) [![AstroDX Group B TestFlight status](https://img.shields.io/badge/Group%20B-closed-yellow)](https://testflight.apple.com/join/ocj3yptn) [![AstroDX Group C TestFlight status](https://img.shields.io/badge/Group%20C-closed-yellow)](https://testflight.apple.com/join/CuMxZE2M) [![AstroDX Group D TestFlight status](https://img.shields.io/badge/Group%20D-closed-yellow)](https://testflight.apple.com/join/T6qKfV6f).
